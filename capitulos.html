...
<div class="mixer">
    {% for c in mexiko %}
        ...
        <div class="chapter mix {{c.country | downcase }} {{ c.subject_ref | downcase }}">
            ...
            <p class="excerpt">{{c.content | strip_html | truncate: 140, '[...]'}} <br><a href="{{ site.baseurl }}/{{ c.parentname | downcase }}/#{{ c.subject }}" class="more">{{ site.t[page.lang].weiterlesen }} &raquo;</a></p>
        </div>
        {% endif %}
    {% endfor %}
    {% for c in kolumbien %}
